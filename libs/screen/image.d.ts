...
interface ImageG {
     ...
     * Set pixel color
     */
    //% shim=ImageGMethods::setPixel blockNamespace="images" group="Drawing"
     ...
     * Get a pixel color
     */
    //% shim=ImageGMethods::getPixel blockNamespace="images" group="Drawing"
     ...
     */
    //% shim=ImageGMethods::fill blockNamespace="images" group="Drawing"
     ...
     */
    //% shim=ImageGMethods::flipX blockNamespace="images" group="Transformations"
     ...
     */
    //% shim=ImageGMethods::flipY blockNamespace="images" group="Transformations"
     ...
     */
    //% shim=ImageGMethods::scroll blockNamespace="images" group="Transformations"
     ...
     */
    //% shim=ImageGMethods::replace blockNamespace="images" group="Transformations"
...
declare namespace image {
    ...
    //% help=images/create
    function create(width: number, height: number): ImageG;
}